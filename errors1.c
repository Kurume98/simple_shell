...
/**
 * my_erratoi - to converts a string to an integer
...
int my_erratoi(char *s)
{
	...
	if (*s == '+')
		s++;  /* TODO: why does this make main return of 255? */
	for (i = 0;  s[i] != '\0'; i++)
	{
		if (s[i] >= '0' && s[i] <= '9')
		{
...
/**
 * convert_number - to converter function, a clone of itoa
 * @num: number
 * @base: base
...
/**
 * remove_comments - function replacing first instance of '#' with '\0'
